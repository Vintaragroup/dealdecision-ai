...
import {
  ...
  OVERVIEW_SCHEMA_MAX,
  parseJsonOnly,
  normalizeKpiForNarrationExcerpt,
  buildAllowlistedNarrationExcerpt,
  sanitizeLlmOverviewV1AfterGuard,
  repairInvestmentAnalysisOverviewStructure,
  sanitizeOverviewCandidateBeforeGuard,
  sanitizeAndValidateOverviewOrDropCitations,
  ensureStructuredRevenueSelectionReason,
  applyStructuredNumericTrustGates,
  ensureStructuredSummaryKpis,
  mapDecisionV1ToReportRecommendation,
  mapDecisionV1ToReportGrade,
  alignReportFieldsToDecisionV1,
  titleCaseFromKey,
  decisionV1DisplayLabel,
  alignReportSectionsToDecisionV1,
  _bqBandFromKey,
  _bqBandKeyFromScoreBandKey,
  _eqLabelFromScore,
  _eqGateFromScore,
  _cvLabelFromScore,
  _cvGateFromScore,
  _canonicalVerdictFromDecisionKey,
  _verdictLabel,
} from '../lib/reports/report-pure-helpers';
export { applyStructuredNumericTrustGates };

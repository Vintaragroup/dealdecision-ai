...
| ✅ | `L3-USEFULNESS` | Investor note #2 surfaced: Key driver of value is brand + distribution expansion... | 2/5 terms | Key driver of value is brand + distribution expansion |
...
| ✅ | `L3-USEFULNESS` | Investor note #4 surfaced: Wholesale execution will determine next growth phase... | 4/5 terms | Wholesale execution will determine next growth phase |
...
| ✅ | `L5-COMPLETENESS` | go_to_market is populated | TAM Assumptions: Help me understand the TAM calculation. The |  |
...
| ✅ | `L3-USEFULNESS` | Investor note #1 surfaced: This is an early-stage AI/data company with limited proof of... | 3/5 terms | This is an early-stage AI/data company with limited proof of commercialization |
...
| ✅ | `L3-USEFULNESS` | Investor note #4 surfaced: Success depends on securing sportsbook partnerships and scal... | 4/5 terms | Success depends on securing sportsbook partnerships and scaling distribution |
...
| ✅ | `L5-COMPLETENESS` | market_positioning is populated | Business model: Omnichannel (DTC + Wholesale/Retail) |  |
...
| ✅ | `L3-USEFULNESS` | Investor note #4 surfaced: Success depends heavily on distribution and brand strength... | 5/5 terms | Success depends heavily on distribution and brand strength |

      ...
      report: {
        ...
        metadata: {
          ...
          canonical_decision_v2: {
            verdict: 'investigate',
            verdict_label: 'Investigate',
            business_quality_score: 50,
            business_quality_band: 'early_consideration',
            evidence_gate: 'caution',
            conviction_gate: 'clear',
            confidence: null,
            confidence_label: null,
            conflict_detected: false,
            hard_pass_guardrail_triggered: false,
            source_v1_decision_key: 'consider',
            stub: true,

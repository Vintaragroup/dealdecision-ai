    ...
    <div className="bg-zinc-800/40 rounded-[14px] p-8">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          {strengths.length === 0 ? (
            <p className="text-sm text-zinc-500 italic">No high-scoring dimensions identified yet.</p>
          ) : (
        ...
        <div className="space-y-4">
          {concerns.length === 0 ? (
            <p className="text-sm text-zinc-500 italic">No concern signals identified.</p>
          ) : (

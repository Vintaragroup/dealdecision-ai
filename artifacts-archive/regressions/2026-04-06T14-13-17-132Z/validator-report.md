...
| Probility | 17 | 1 | 0 | 97% | 🔴 1 failing |
| ToxyScreen | 17 | 0 | 0 | 100% | 🟢 All pass |
| Verse | 17 | 1 | 0 | 98% | 🔴 1 failing |
| **TOTAL** | **84** | **2** | **1** | — | |

### Open issues

- **[L5-COMPLETENESS]** Probility — go_to_market is populated: FAIL — field 'go_to_market' is empty or null
- **[L3-USEFULNESS]** Verse — Investor note #4 surfaced: Success depends heavily on distribution and brand strength...: FAIL — none of ['success', 'depends', 'heavily'] found in understanding output
...
### 🟡 Probility  (17/18 checks passing, 94%)
...
| ❌ | `L5-COMPLETENESS` | go_to_market is populated | — |  |
...
| ❌ | `L3-USEFULNESS` | Investor note #4 surfaced: Success depends heavily on distribution and brand strength... | 0/5 terms | Success depends heavily on distribution and brand strength |

...
export interface FinancialHealthScore {
  ...
  score: number | null;
  is_proxy: boolean;
  /** true when FHC was computed from deck signals only (no XLSX/structured sources).
   *  ORS treats deck-only FHC the same as insufficient_data and uses the DCI-derived proxy. */

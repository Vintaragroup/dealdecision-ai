...
export interface ConvictionContributorV1 {
	key: string;
	label: string;
...
export interface ConvictionUnknownV1 {
	code: string;
	text: string;
	evidence_refs: string[];
}

export interface ConvictionContradictionV1 {
	code: string;
	text: string;
...
export interface ConvictionRequiredCheckV1 {
	text: string;
	expected_direction: 'increase' | 'decrease' | 'clarify';
	evidence_refs: string[];
}

export interface ConvictionLineageArtifactV1 {
	artifact: string;
	path: string;
	used: boolean;
	note?: string;

...
import {
  ...
  detectStage,
} from "./render-package-helpers.js";

import { computeDocumentConfidenceIndex, type DciRawInputs } from "./compute-dci.js";
import { computeFinancialHealthComposite, type FhcRawInputs } from "./compute-fhc.js";
import {
  computeUnifiedRiskSeverity,
  type UrssInputs,
  type UrssConflict,
} from "./compute-urss.js";
import {
...
/** Alias for the RenderPackage type used as the orchestrator's primary input. */
export type InvestorInsightsRenderPackage = RenderPackage;
...
function buildExecutiveSummarySegment(rp: RenderPackage): ExecutiveSummarySegment {
...
function buildFinancialBenchmarks(rp: RenderPackage): FinancialSegment["benchmarks"] {
...
export function buildOrchestratorReportV1(args: {
  dealId: string;
  renderPackage: InvestorInsightsRenderPackage;
}): OrchestratorReportV1 {
  ...
  const orsInputs = {
    ...
    fhc_is_deck_only_fsi: fhc.is_deck_only_fsi,
